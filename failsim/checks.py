...
class OpticsChecks:
    ...
    def __init__(self, separation: bool = True,
                 beta: bool = True,
    ...
    def check_separations(self, twiss_df_b1: pandas.DataFrame,
        ...
        pymask.check_separations_against_madvars(separations_to_check,
                                                 twiss_df_b1, twiss_df_b2,
                                                 variables_dict)

    def check_betas(self, beam: str, twiss_df: pandas.DataFrame,
                    variables_dict: dict):
        ...
        pymask.check_twiss_against_madvars(twiss_value_checks, twiss_df,
                                           variables_dict)

    def __call__(self, mad: pymask.Madxp,
                 sequences: List[str],
                 twiss_name: str = 'twiss'):
